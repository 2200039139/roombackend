...
app.use(cors({
  origin: ['https://splitta1.vercel.app', 'http://localhost:3000'],
  credentials: true,
...
app.use((req, res, next) => {
  const allowedOrigins = ['https://splitta1.vercel.app', 'http://localhost:3000'];
...
app.get('/api/health', (req, res) => {
  res.json({ 
    ...
    allowedOrigins: ['https://splitta1.vercel.app', 'http://localhost:3000']
  });
});
...
app.post('/api/users/login', async (req, res) => {
  ...
  res.header('Access-Control-Allow-Origin', 'https://splitta1.vercel.app');
  res.header('Access-Control-Allow-Credentials', 'true');
...
// ... (rest of your routes remain the same - roommates, expenses, settlements, balances)
...
app.listen(port, '0.0.0.0', () => {
  ...
  console.log('CORS enabled for:', ['https://splitta1.vercel.app', 'http://localhost:3000']);
});
